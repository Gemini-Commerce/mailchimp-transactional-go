...
*/
func (a *RejectsApiService) PostRejectsAdd(ctx context.Context, body RejectsAddBody) (InlineResponse20040, *http.Response, error) {
	var (
...
*/
func (a *RejectsApiService) PostRejectsDelete(ctx context.Context, body RejectsDeleteBody) (InlineResponse20042, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *RejectsApiService) PostRejectsList(ctx context.Context, body RejectsListBody) ([]InlineResponse20041, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
