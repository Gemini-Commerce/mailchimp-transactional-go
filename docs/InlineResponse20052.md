...
**SentHourly** | **int32** | the number of emails the subaccount has sent in the last hour | [optional] [default to null]
**HourlyQuota** | **int32** | the current hourly quota for the subaccount, either manual or reputation-based | [optional] [default to null]
**Last30Days** | [***InlineResponse20052Last30Days**](inline_response_200_52_last_30_days.md) |  | [optional] [default to null]
